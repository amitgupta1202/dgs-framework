...
public interface DgsReactiveQueryExecutor {
     ...
     * @return Returns a GraphQL [ExecutionResult]. This includes data and errors.
     */
    Mono<ExecutionResult> execute(String query, Map<String, Object> variables, Map<String,Object> extensions, HttpHeaders headers, String operationName, ServerHttpRequest serverHttpRequest);
