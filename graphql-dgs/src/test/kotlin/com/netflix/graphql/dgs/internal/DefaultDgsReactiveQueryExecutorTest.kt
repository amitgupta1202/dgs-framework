...
internal class DefaultDgsReactiveQueryExecutorTest {
    ...
    lateinit var dgsQueryExecutor: DefaultDgsReactiveExecutor
    ...
    fun createExecutor() {
        ...
        dgsQueryExecutor = DefaultDgsReactiveExecutor(
            schema, provider, dgsDataLoaderProvider, DefaultDgsGraphQLContextBuilder(
                Optional.empty()
